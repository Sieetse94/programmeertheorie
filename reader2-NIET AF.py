...
class vakgegevens:
    ...
    def __init__(self, vak, hoorcolleges, werkcolleges, max_werkcolleges, practica, max_practica, studentenaantal):
        ...
        self.hoorcollege1 = None
        self.hoorcollege2 = None
        self.hoorcollege3 = None

        self.werkcollege1 = None
        self.werkcollege2 = None
        self.werkcollege3 = None
        self.werkcollege4 = None
...
def add_hoorcollege(vak):
    ...
    if (aantal >= 1):
        vakken[vak].hoorcollege1 = vakken[vak].vak + ": hoorcollege1"
    if (aantal >= 2):
        vakken[vak].hoorcollege2 = vakken[vak].vak + ": hoorcollege2"
    if (aantal == 3):
        vakken[vak].hoorcollege3 = vakken[vak].vak + ": hoorcollege3"

def add_werkcollege(vak):
    aantal = vakken[vak].aantal_werkcolleges
    if (aantal >= 1):
        vakken[vak].werkcollege1 = vakken[vak].vak + "werkcollege1"
    if (aantal >= 2):
        vakken[vak].werkcollege2 = vakken[vak].vak + "werkcollege2"
    if (aantal >= 3):
        vakken[vak].werkcollege3 = vakken[vak].vak + "werkcollege3"
    if (aantal == 3):
        vakken[vak].werkcollege4 = vakken[vak].vak + "werkcollege4"

def add_practica(vak):
    aantal = vakken[vak].aantal_practica
    if (aantal >= 1):
        vakken[vak].practica1 = vakken[vak].vak + "practica1"
    if (aantal >= 2):
        vakken[vak].practica2 = vakken[vak].vak + "practica2"
    if (aantal >= 3):
        vakken[vak].practica3 = vakken[vak].vak + "practica3"
    if (aantal >= 4):
        vakken[vak].practica4 = vakken[vak].vak + "practica4"
    if (aantal >= 5):
        vakken[vak].practica5 = vakken[vak].vak + "practica5"
    if (aantal == 6):
        vakken[vak].practica6 = vakken[vak].vak + "practica6"
...
for vak in range(len(vakken)):
    ...
    add_werkcollege(vak)
    add_practica(vak)
    print(vakken[vak].hoorcollege3, vakken[vak].hoorcollege2, vakken[vak].hoorcollege1)
